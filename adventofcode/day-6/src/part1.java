...
public class part1 {
    public static void main(String[] args) {
        ...
        for (String x :  inputlist) {
            ArrayList<String> groep = new ArrayList<String>();
            for (int i = 0; i < x.length(); i++) {
                if (x.charAt(i) != '\n') {
                if (!groep.contains(String.valueOf(x.charAt(i)))) {
                    System.out.println(x.charAt(i));
                    groep.add(String.valueOf(x.charAt(i)));
                }
                }
            }
            som += groep.size();
            System.out.println(groep.size());
        }
