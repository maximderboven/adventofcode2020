...
public class part2 {
    public static void main(String[] args) {
        ...
        for (String x : inputlist) {
            ArrayList<String> groepall = new ArrayList<String>();
            ArrayList<String> groepunique = new ArrayList<String>();
            int personcounter = 0;
            for (int i = 0; i < x.length(); i++) {
                if (x.charAt(i) != '\n') {
                    if (!groepunique.contains(String.valueOf(x.charAt(i)))) {
                        groepunique.add(String.valueOf(x.charAt(i)));
                    }
                    groepall.add(String.valueOf(x.charAt(i)));
                } else {
                    personcounter++;
                }
            }
            ...
            if (personcounter !=0) {
            for (String un: groepunique) {
                if (Collections.frequency(groepall, un) > personcounter)
                {
                    som++;
                }
            }
            } else {
                som += groepunique.size();
            }
        }
