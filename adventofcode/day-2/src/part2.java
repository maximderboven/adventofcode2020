...
public class part2 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < passwords.length; i++) {
            String[] cutted = passwords[i].split("-| |: ", 4);
            int first = Integer.parseInt(cutted[0]);
            int second = Integer.parseInt(cutted[1]);
            char karakter = cutted[2].charAt(0);
            if ((cutted[3].charAt(first-1) == karakter && cutted[3].charAt(second-1) != karakter) || (cutted[3].charAt(first-1) != karakter && cutted[3].charAt(second-1) == karakter))
            {
                correct++;
            }
        }
