...
public class part1 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < passwords.length; i++) {
            ...
            int lowest = Integer.parseInt(cutted[0]);
            int heighest = Integer.parseInt(cutted[1]);
            char karakter = cutted[2].charAt(0);
            int teller = 0;
            for (int j = 0; j < cutted[3].length(); j++) {
                if (cutted[3].charAt(j) == karakter)
                {
                    teller++;
                }
            }
            if (teller >= lowest && teller <= heighest)
            {
                correct++;
            }
        }
